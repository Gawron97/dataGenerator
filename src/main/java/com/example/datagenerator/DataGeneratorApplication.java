...
//        fillTable.fillTable().officeWorker().generateOfficeWorker(1000);
//        fillTable.fillTable().securityWorker().generateSecurity(1000);
//        fillTable.fillTable().student().generateStudents(1000);
//        fillTable.fillTable().additionalRoomType().generateAdditionalRoomTypes();
//        fillTable.fillTable().additionalRoom().generateAdditionalRooms(2000);
//        fillTable.fillTable().complain().generateComplains(1500);
...
//                                                            LocalDate.of(2023,12,31),1000);
//        fillTable.fillTable().paymentStatus().generatePaymentStatuses();
//        fillTable.fillTable().payment().generatePayments(2000);
...
//        fillTable.fillTable().application().generateApplications(2000);
